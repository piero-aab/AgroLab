...
function link(tel, message){
  var isMobile = /iPhone|iPad|iPod|Android/i.test(navigator.userAgent);
  var element = document.getElementById('text');
  if (isMobile) {
    element = `https://api.whatsapp.com/send?phone=+${tel}&text=${encodeURIComponent(message)}`;
  } else {
    element = `https://web.whatsapp.com/send?phone=+${tel}&text=${encodeURIComponent(message)}`;
  }
